...
<script type="text/javascript">
  ...
  var billingThisMonth = ajaxPostLink({"action":"getBillingViaMonth","userID":userID});
  var totalToPay;

  if (billingThisMonth.length >= 1) {
    totalToPay = parseFloat(billingThisMonth[0].water)+parseFloat(billingThisMonth[0].electricity)+parseFloat(billingThisMonth[0].rent)+parseFloat(billingThisMonth[0].others);

    $("#water_container").text(billingThisMonth[0].water);
    $("#electricity_container").text(billingThisMonth[0].electricity);
    $("#rent_container").text(billingThisMonth[0].rent);
    $("#others_container").text(billingThisMonth[0].others);
              ...
              return actions.order.capture().then(function(details){
                  ...
                  if(details['status'] == 'COMPLETED'){
                   ...
                   Swal.fire(
                     ...
                     formData.append("action", "uploadBillingProofOfPayment");
  ...
  $("#proofOfPayment_form").validate({
    submitHandler: function(form) {
      ...
      formData.append("userID", userID);
      formData.append("reservationID", reservationID);
      formData.append("paymentType", $('input[type=radio][name=paymentMethod]')[0].value);
