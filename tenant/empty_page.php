            ...
            <ul class="metismenu" id="menu">
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  ...
                  <li>
                    <a href="registration_billing.html">Registration Billing</a>
                  </li>
                  <li>
                    <a href="registration_payment.html">Registration Payment</a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="transactions_billing.html">Billings</a>
                  </li>
                  <li>
                    <a href="transaction_payment.html">Payments</a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="invoice">Monthly Payments Invoice</a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="information_profile.html">Tenants Profile</a>
                  </li>
                  <li>
                    <a href="information_calendar.html">Tenants Calendar</a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="room_transfer.html">Room Transfer</a>
                  </li>
                  <li>
                    <a href="room_checkout.html">Room Checkout</a>
                  </li>
                </ul>
              </li>
            </ul>
                ...
                <ul class="navbar-nav header-right">
                  ...
                  <li class="nav-item dropdown notification_dropdown">
                    ...
                    >
                      ...
                      <span
                        class="badge light text-white bg-warning rounded-circle"
                        >12</span
                      >
                    </a>
                  ...
                  <li class="nav-item dropdown notification_dropdown">
                    <a class="nav-link bell-link" href="javascript:void(0);">
                      ...
                      <span
                        class="badge light text-white bg-danger rounded-circle"
                        >76</span
                      >
                    </a>
                  </li>
                  ...
                  <li class="nav-item dropdown notification_dropdown">
                    ...
                    >
                      ...
                      <span
                        class="badge light text-white bg-success rounded-circle"
                        >!</span
                      >
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
