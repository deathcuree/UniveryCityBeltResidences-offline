          ...
          <div class="dlabnav-scroll">
            <ul class="metismenu" id="menu">
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="registered-users-page.php">Registered Users</a>
                  </li>
                  <li>
                    <a href="registration_form.php">Registration Form</a>
                  </li>
                  <li>
                    <a href="registration_billing.php">Registration Billing</a>
                  </li>
                  <li>
                    <a href="registration_payment.php">Registration Payment</a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="transactions_billing.php">Transactions Billing</a>
                  </li>
                  <li>
                    <a href="transaction_payment.php">Transactions Payment</a>
                  </li>
                  <li>
                    <a href="inquirers_security.php">Security Deposit</a>
                  </li>
                  <li><a href="inquirers_utility.php">Utility Deposit</a></li>
                  <li>
                    <a href="inquirers_bedsheet.php">Bedsheet Deposit</a>
                  </li>
                  <li><a href="pro-rated_rental.php">Pro-rated Rental</a></li>
                  <li>
                    <a href="monthly_rental.php">Monthly Rent Payment</a>
                  </li>
                  <li>
                    <a href="monthly_electrical.php">Monthly Electric Payment</a>
                  </li>
                  <li>
                    <a href="monthly_water.php">Monthly Water Payment</a>
                  </li>
                  <li>
                    <a href="deposit_refund.php">Deposits Return</a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="invoice_deposits.php">Deposits Invoice</a>
                  </li>
                  <li>
                    <a href="invoice_monthly.php">Monthly Payments Invoice</a>
                  </li>
                  <li>
                    <a href="invoice_return.php">Return of Deposits Invoice</a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="rooms_available.php">Rooms Available</a>
                  </li>
                  <li>
                    <a href="room_edit.php">Room Edit</a>
                  </li>
                  <li>
                    <a href="rooms_occupied.php">Rooms Occupied</a>
                  </li>
                  <li>
                    <a href="rooms_maintenance.php">Rooms Maintenance</a>
                  </li>
                  <li>
                    <a href="room_details.php">Room Details</a>
                  </li>
                  <li>
                    <a href="room_transfer.php">Room Transfer</a>
                  </li>
                  <li>
                    <a href="room_checkout.php">Room Checkout</a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="information_tenants.php">Tenants</a>
                  </li>
                  <li>
                    <a href="information_profile.php">Tenants Profile</a>
                  </li>
                  <li>
                    <a href="information_calendar.php">Tenants Calendar</a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="biometrics_tenants.php">Biometrics Tenants</a>
                  </li>
                  <li>
                    <a href="biometrics_admin.php">Registered Admins</a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li>
                    <a href="reading_electricity.php">Electricity Reading</a>
                  </li>
                  <li><a href="reading_water.php">Water Reading</a></li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul aria-expanded="false">
                  <li><a href="settings_admin.php">Admin Settings</a></li>
                </ul>
              </li>
            </ul>
          </div>
            ...
            <nav class="navbar navbar-expand">
              <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                  <div class="dashboard_bar">Template</div>
                </div>
