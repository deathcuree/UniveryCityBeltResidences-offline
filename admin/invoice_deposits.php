    ...
    <div class="row page-titles">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">
          <a href="javascript:void(0)">Deposits Invoice</a>
        </li>
          ...
          <div class="row align-items-center">
            <div class="border-0 mb-4">
              <div class="card-header no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                <h3 class="fw-bold mb-0 py-3 pb-2">Deposits Invoice</h3>
                        ...
                        <div class="card__body d-sm-flex justify-content-between">
                          <a href="javascript:void(0);" class="d-flex">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="text-muted">Security Deposit Payment</span>
                            </div>
                          </a>
                        ...
                        <div class="card-body d-sm-flex justify-content-between">
                          <a href="javascript:void(0);" class="d-flex">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="text-muted">Utility Deposit Payment</span>
                            </div>
                          </a>
                          <div class="text-end d-none d-md-block">
                            <p class="mb-1">
                        ...
                        <div class="card-body d-sm-flex justify-content-between">
                          <a href="javascript:void(0);" class="d-flex">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="text-muted">Bedsheet Deposit Payment</span>
                            </div>
                          </a>
                          <div class="text-end d-none d-md-block">
                            <p class="mb-1">
                        ...
                        <div class="card-body d-sm-flex justify-content-between">
                          <a href="javascript:void(0);" class="d-flex">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="text-muted">Pro-Rated Rental Deposit Payment</span>
                            </div>
                          </a>
                          <div class="text-end d-none d-md-block">
                            <p class="mb-1">
                            ...
                            <table class="table table-striped">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="text-center">Ryan</td>
                                  <td class="text-center">
                                    Pro-Rated Rental Deposit (1st Month)
                                  </td>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-12 text-end">
                              <button type="button" class="btn btn-primary btn-sm my-1">
                                <i class="fa fa-paper-plane-o"></i>Edit
                              </button>
