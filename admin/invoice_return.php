    ...
    <div class="row page-titles">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">
          <a href="javascript:void(0)">Return of Deposits Invoice</a>
        </li>
                        ...
                        <div class="card__body d-sm-flex justify-content-between">
                          <a href="javascript:void(0);" class="d-flex">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="text-muted">Security Deposit Returned</span>
                            </div>
                          </a>
                        ...
                        <div class="card-body d-sm-flex justify-content-between">
                          <a href="javascript:void(0);" class="d-flex">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="text-muted">Utility Deposit Returned</span>
                            </div>
                          </a>
                          <div class="text-end d-none d-md-block">
                            <p class="mb-1">
                        ...
                        <div class="card-body d-sm-flex justify-content-between">
                          <a href="javascript:void(0);" class="d-flex">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="text-muted">Bedsheet Deposit Returned</span>
                            </div>
                          </a>
                          <div class="text-end d-none d-md-block">
                            <p class="mb-1">
                        ...
                        <div class="card-body d-sm-flex justify-content-between">
                          <a href="javascript:void(0);" class="d-flex">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                              ...
                              <span class="text-muted">Pro-Rated Rental Deposit Returned</span>
                            </div>
                          </a>
                          <div class="text-end d-none d-md-block">
                            <p class="mb-1">
                            ...
                            <table class="table table-striped">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td class="text-center">12/02/23</td>
                                </tr>
                                <tr>
                                  <td class="text-center">001</td>
                                  <td class="text-center">1</td>
