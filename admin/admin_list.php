        ...
        <div class="card mt-3">
          <div class="card">
            <div class="card-body">
              ...
              <button class="btn btn-primary" id="addNewAdmin_btn">
                Add new admin user
              </button>
...
<script type="text/javascript">
  var selectedData;
  var getAllReservations = ajaxPostLink({"action":"getAllAdminUsers"});
  ...
  $("#addNewAdmin_btn").on("click",function(){
    var page = ajaxPostLink({'action':"loadPage",'pagename':'admin/addNewAdminUser'});
